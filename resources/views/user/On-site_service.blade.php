                ...
                <div class="basic-form">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <textarea class="form-control" id="val-suggestions" name="val-suggestions" rows="5" placeholder="کاربر محترم لطفا آدرس دقیق جهت مراجعه خودرو امداد یاداشت نمایید"></textarea>
                            </div>
                        </div>
