                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" method="post" action="{{route('user.login.send_sms')}}">
                                    @csrf
                                    <div class="form-group">
                                        <input type="tel" class="form-control" placeholder="شماره موبایل" required name="phone">
                                    </div>

                                    <button class="btn login-form__btn submit w-100">ورود</button>
                                </form>
                            </div>
                        </div>
                    </div>
