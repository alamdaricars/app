    ...
    <div class="d-flex flex-row col-12">
        ...
        <div class="box2 col-3">
            <div class="success">
                ...
                <div class="success__title">در انتظار تایید نوبت مشتری توسط پذیرشگر :{{count($turns->where('status',0) )}}</div>
            </div>
        </div>
        <div class="box2 col-2">
            <div class="success">
                ...
                <div class="success__title">  در انتظار تایید سرویس در محل:{{count($turns_on_side->where('status',0) )}}</div>
            </div>
        </div>
        <div class="box2 col-2">
            <div class="success">
                ...
                <div class="success__title">پذیرش فعال:   {{count($admission_details->where('status','!=',5)->where('status','!=',4) )}}</div>
            </div>
        </div>
    ...
    <div class="d-flex flex-row col-12">
        ...
        <div class="box2 col-3">
            <div class="warning">
                ...
                <div class="warning__title">رزرو های امروز :{{count($test)}}</div>
            </div>
        </div>
